...
namespace MvcApplication1.Models
{
    ...
    #region 模型
    [PropertiesMustMatch("NewPassword", "ConfirmPassword", ErrorMessage = "新密碼與確認密碼不相符。")]
    ...
    [PropertiesMustMatch("Password", "ConfirmPassword", ErrorMessage = "密碼和確認密碼不相符。")]
    ...
    {
        private const string _defaultErrorMessage = "'{0}' 與 '{1}' 不相符。";
